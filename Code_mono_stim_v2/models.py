...
class Mouse:
    ...
    # (whisker=1, auditif=2), chacun avec son propre gain appris. Tous les champs ci-dessous
    # sont suffixes _wa et n'entrent JAMAIS en jeu pour le mono ou le dual gauche/droite —
    # aucun risque de collision avec exp_update_stim/learning_stim (mono) ou stim_gain_max
    # (dual gauche/droite, valeur differente : 0.6 vs 8.0 ici).
